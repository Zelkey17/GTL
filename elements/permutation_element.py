...
class PermutationElement(Element[list[int]]):
    def __init__(self, value: list[int], reference_to_group: Group[
        list[int], 'PermutationElement']):
